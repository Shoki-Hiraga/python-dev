...
# ヘッダー行
header_row = ['URL', '車種グレード', '新車価格', '新車価格予備', '車項目', '車情報','エンジン項目','エンジン情報','ドライブ項目','ドライブ情報']

# スクレイピング対象の複数のURLをリストで定義  URL設定 URLリスト生成とセット のどちらか一方
urls = [
'https://www.goo-net.com/catalog/MITSUBISHI/LANCER/10096712/',
'https://www.goo-net.com/catalog/MITSUBISHI/LANCER/10096712/',
'https://www.goo-net.com/catalog/MITSUBISHI/LANCER/10096712/',
'https://www.goo-net.com/catalog/MITSUBISHI/LANCER/10096712/',
'https://www.goo-net.com/catalog/MITSUBISHI/LANCER/10096712/',
...
# ファイルパス
# csv_directory = 'C:/Users/RAYTREK/Downloads'
csv_directory = 'C:/Users/STAFF1088/Downloads'
csv_filename = "carspecdata_goo.csv"
