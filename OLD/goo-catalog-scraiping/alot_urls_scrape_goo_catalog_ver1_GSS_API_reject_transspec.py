...
urls = [
'https://www.goo-net.com/catalog/TOYOTA/HIACE_WAGON/10142852/',
'https://www.goo-net.com/catalog/TOYOTA/HIACE_WAGON/10142851/',
'https://www.goo-net.com/catalog/TOYOTA/HIACE_WAGON/10142858/'
]
...
def scrape_url(url):
    ...
    selectors = [
        ...
        ('.box_spec table.mb20:nth-of-type(2) th', 'text'),
        ('.box_spec table.mb20:nth-of-type(2) td', 'text')
    ]
